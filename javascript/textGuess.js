...
const questions = [
  ...
  },
  {
    ...
    messages: [
      ...
      { sender: 'Jinny', body: 'Thats just traumatizing' },
      { sender: 'Phillip Han', body: 'alright if none of us goes to college' },
      { sender: 'Jinny', body: 'I- what' },
      { sender: 'Phillip Han', body: 'damn' },
    ],
  },
  {
    title: 'HEAVEN',
