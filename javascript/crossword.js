  ...
  function (e, t) {
    ...
    w.extend = w.fn.extend = function () {
      ...
      for (
        ...
        s < u;
        s++
      ) if (null != (e = arguments[s])) for (t in e) n = a[t],
      a !== (r = e[t]) &&
      (
        l &&
        r &&
    ...
    w.extend({
      ...
      makeArray: function (e, t) {
        ...
        [];
        return null != e &&
        (C(Object(e)) ? w.merge(n, 'string' == typeof e ? [
          e
        ] : e) : s.call(n, e)),
        n
      },
    ...
    var E = function (e) {
      ...
      ee = function (e, t, n) {
        var r = '0x' + t - 65536;
        return r !== r ||
        n ? t : r < 0 ? String.fromCharCode(r + 65536) : String.fromCharCode(r >> 10 | 55296, 1023 & r | 56320)
      },
      ...
      function de(e) {
        return function (t) {
          ...
          t.isDisabled !== !e &&
          ie(t) === e : t.disabled === e : 'label' in t &&
          t.disabled === e
        }
      }
      function he(e) {
      ...
      p = oe.setDocument = function (e) {
        ...
        a.documentElement ? (
          ...
          i.top !== i &&
          (
            i.addEventListener ? i.addEventListener('unload', re, !1) : i.attachEvent &&
          ...
          D = t ? function (e, t) {
            ...
            (
              ...
              !n.sortDetached &&
              t.compareDocumentPosition(e) === r ? e === d ||
              e.ownerDocument === w &&
              x(w, e) ? - 1 : t === d ||
              t.ownerDocument === w &&
              x(w, t) ? 1 : c ? O(c, e) - O(c, t) : 0 : 4 & r ? - 1 : 1
            )
          }
           : function (e, t) {
            if (e === t) return f = !0,
      ...
      oe.attr = function (e, t) {
        ...
        o = i &&
        N.call(r.attrHandle, t.toLowerCase()) ? i(e, t, !g) : void 0;
        return void 0 !== o ? o : n.attributes ||
        !g ? e.getAttribute(t) : (o = e.getAttributeNode(t)) &&
          ...
          filter: {
            ...
            ATTR: function (e, t, n) {
              return function (r) {
                ...
                (
                  ...
                  0 === i.indexOf(n) : '*=' === t ? n &&
                  i.indexOf(n) > - 1 : '$=' === t ? n &&
                  i.slice( - n.length) === n : '~=' === t ? (' ' + i.replace($, ' ') + ' ').indexOf(n) > - 1 : '|=' === t &&
               ...
               : function (t, n, u) {
                ...
                if (y) {
                  ...
                  if (h = [
                    ...
                    x = (
                      d = (
                        l = (c = (f = (p = y) [b] || (p[b] = {})) [p.uniqueID] || (f[p.uniqueID] = {})) [e] ||
                        []
                      ) [0] === T &&
                      l[1]
                    ) &&
                    ...
                    (
                      x = d = (
                        l = (c = (f = (p = t) [b] || (p[b] = {})) [p.uniqueID] || (f[p.uniqueID] = {})) [e] ||
                        []
                      ) [0] === T &&
                      l[1]
                    ),
                    !1 === x
                  ) while (p = ++d && p && p[g] || (x = d = 0) || h.pop()) if (
            ...
            PSEUDO: function (e, t) {
              ...
              return i[b] ? i(t) : i.length > 1 ? (
                ...
                r.setFilters.hasOwnProperty(e.toLowerCase()) ? se(
                  function (e, n) {
                    var r,
                    o = i(e, t),
                    a = o.length;
            ...
            lang: se(
              function (e) {
                ...
                function (t) {
                  ...
                  do {
                    if (
                      n = g ? t.lang : t.getAttribute('xml:lang') ||
                      t.getAttribute('lang')
      ...
      a = oe.tokenize = function (e, t) {
        ...
        while (s) {
          ...
          for (a in r.filter) !(i = V[a].exec(s)) ||
          l[a] &&
          !(i = l[a](i)) ||
          (
            n = i.shift(),
      ...
      function me(e, t, n) {
        ...
        return t.first ? function (t, n, i) {
         ...
         : function (t, n, u) {
          ...
          } else while (t = t[r]) if (1 === t.nodeType || a) if (
            f = t[b] ||
            (t[b] = {}),
            c = f[t.uniqueID] ||
            (f[t.uniqueID] = {}),
        ...
        if (n = n || q, 'string' == typeof e) {
          ...
          if (i[1]) {
            if (
              ...
              w.merge(this, w.parseHTML(i[1], t && t.nodeType ? t.ownerDocument ||
              t : r, !0)),
              A.test(i[1]) &&
              w.isPlainObject(t)
    ...
    w.fn.extend({
      ...
      closest: function (e, t) {
        ...
        a = 'string' != typeof e &&
        w(e);
        if (!D.test(e)) for (; r < i; r++) for (n = this[r]; n && n !== t; n = n.parentNode) if (
          n.nodeType < 11 &&
    ...
    w.Callbacks = function (e) {
      ...
      u = function () {
        for (i = i || e.once, r = t = !0; a.length; s = - 1) {
          n = a.shift();
          while (++s < o.length) !1 === o[s].apply(n[0], n[1]) &&
          e.stopOnFalse &&
          (s = o.length, n = !1)
        }
        e.memory ||
    ...
    function $(e, t, n, r) {
      ...
      try {
        e &&
        g(i = e.promise) ? i.call(e).done(t).fail(n) : e &&
        g(i = e.then) ? i.call(e, t, n) : t.apply(void 0, [
          e
        ].slice(r))
      } catch (e) {
        n.apply(void 0, [
                  ...
                  function (n, r) {
                    ...
                    o[r[1]](
                      function () {
                        ...
                        e &&
                        g(e.promise) ? e.promise().progress(t.notify).done(t.resolve).fail(t.reject) : t[r[0] + 'With'](this, i ? [
                          e
                        ] : arguments)
                      }
                    )
    ...
    w.extend({
      ...
      ready: function (e) {
        ...
        (w.isReady = !0, !0 !== e && --w.readyWait > 0 || F.resolveWith(r, [
          w
        ]))
      }
    }),
    ...
    !r.documentElement.doScroll ? e.setTimeout(w.ready) : (
    ...
    w.extend({
      queue: function (e, t, n) {
        ...
        (
          !r ||
          Array.isArray(n) ? r = J.access(e, t, w.makeArray(n)) : r.push(n)
        ),
        r ||
        []
      },
    ...
    w.fn.extend({
      queue: function (e, t) {
        ...
        (t = e, e = 'fx', n--),
        arguments.length < n ? w.queue(this[0], e) : void 0 === t ? this : this.each(
          function () {
      ...
      promise: function (e, t) {
        ...
        e = e ||
        'fx';
        while (a--) (n = J.get(o[a], e + 'queueHooks')) &&
        n.empty &&
        (r++, n.empty.add(s));
        return s(),
        i.promise(t)
    ...
    function xe(e, t, n, r, i) {
      for (
        ...
        d < h;
        d++
      ) if ((o = e[d]) || 0 === o) if ('object' === x(o)) w.merge(p, o.nodeType ? [
        o
      ] : o);
       else if (me.test(o)) {
        a = a ||
    ...
    w.event = {
        ...
        if (y) {
          ...
          (
            a = y.handle = function (t) {
              ...
              w.event.triggered !== t.type ? w.event.dispatch.apply(e, arguments) : void 0
            }
          ),
          l = (t = (t || '').match(M) || [
            ''
      ...
      handlers: function (e, t) {
        ...
        if (u && l.nodeType && !('click' === e.type && e.button >= 1)) for (; l !== this; l = l.parentNode || this) if (1 === l.nodeType && ('click' !== e.type || !0 !== l.disabled)) {
          ...
          (
            a[i] = r.needsContext ? w(i, this).index(l) > - 1 : w.find(i, this, null, [
              l
            ]).length
          ),
          a[i] &&
    ...
    w.each({
      ...
      which: function (e) {
        var t = e.button;
        return null == e.which &&
        we.test(e.type) ? null != e.charCode ? e.charCode : e.keyCode : !e.which &&
        void 0 !== t &&
        Te.test(e.type) ? 1 & t ? 1 : 2 & t ? 3 : 4 & t ? 2 : 0 : e.which
      }
    }, w.event.addProp),
    w.each({
    ...
    function Le(e, t) {
      return N(e, 'table') &&
      N(11 !== t.nodeType ? t : t.firstChild, 'tr') ? w(e).children('tbody') [0] ||
      e : e
    }
    function He(e) {
    ...
    function Re(e, t, n, r) {
      ...
      y = t[0],
      v = g(y);
      if (v || p > 1 && 'string' == typeof y && !h.checkClone && je.test(y)) return e.each(
        function (i) {
          var o = e.eq(i);
          v &&
          (t[0] = y.call(this, i, o.html())),
          Re(o, t, n, r)
        }
      );
      if (
        ...
        (
          l.src &&
          'module' !== (l.type || '').toLowerCase() ? w._evalUrl &&
    ...
    w.fn.extend({
      ...
      text: function (e) {
        return z(
          this,
          function (e) {
            return void 0 === e ? w.text(this) : this.empty().each(
              function () {
                1 !== this.nodeType &&
                11 !== this.nodeType &&
                9 !== this.nodeType ||
    ...
    function et(e, t, n) {
      ...
      return a = a &&
      (h.boxSizingReliable() || i === e.style[t]),
      (
        'auto' === i ||
        !parseFloat(i) &&
      ...
      function (e, t) {
        w.cssHooks[t] = {
          get: function (e, n, r) {
            ...
            e.getBoundingClientRect().width ? et(e, t, r) : se(e, Ue, function () {
              return et(e, t, r)
            })
          },
          set: function (e, n, r) {
    ...
    w.cssHooks.marginLeft = _e(
      h.reliableMarginLeft,
      function (e, t) {
        if (t) return (
          parseFloat(Fe(e, 'marginLeft')) ||
          e.getBoundingClientRect().left - se(
            e,
            {
              marginLeft: 0
            },
    ...
    tt.prototype = {
      ...
      cur: function () {
        ...
        return e &&
        e.get ? e.get(this) : tt.propHooks._default.get(this)
      },
      run: function (e) {
        var t,
        ...
        n &&
        n.set ? n.set(this) : tt.propHooks._default.set(this),
        this
      }
    },
    ...
    tt.propHooks = {
      _default: {
        get: function (e) {
          ...
          null != e.elem[e.prop] &&
          null == e.elem.style[e.prop] ? e.elem[e.prop] : (t = w.css(e.elem, e.prop, '')) &&
          'auto' !== t ? t : 0
        },
        set: function (e) {
    ...
    function at() {
      ...
      (
        !1 === r.hidden &&
        e.requestAnimationFrame ? e.requestAnimationFrame(at) : e.setTimeout(at, w.fx.interval),
        w.fx.tick()
      )
    }
    function st() {
    ...
    function ct(e, t, n) {
      ...
      if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(d)) {
        ...
        (
          y ? 'hidden' in y &&
          (g = y.hidden) : y = J.access(e, 'fxshow', {
            display: l
          }),
          o &&
          (y.hidden = !g),
    ...
    w.each(
      ...
      function (e, t) {
        ...
        w.fn[t] = function (e, r, i) {
          return null == e ||
          'boolean' == typeof e ? n.apply(this, arguments) : this.animate(ut(t, !0), e, r, i)
        }
      }
    ),
    w.each({
    ...
    w.extend({
      attr: function (e, t, n) {
        ...
        i,
        o = e.nodeType;
        if (3 !== o && 8 !== o && 2 !== o) return 'undefined' == typeof e.getAttribute ? w.prop(e, t, n) : (
          1 === o &&
          w.isXMLDoc(e) ||
          (
          ...
          void 0 !== n ? null === n ? void w.removeAttr(e, t) : i &&
          'set' in i &&
    ...
    w.fn.extend({
      ...
      toggleClass: function (e, t) {
        ...
        r ? t ? this.addClass(e) : this.removeClass(e) : g(e) ? this.each(
          function (n) {
        ...
        i = this[0];
        {
          ...
          this.each(
            function (n) {
              ...
              1 === this.nodeType &&
              (
                null == (i = r ? e.call(this, n, w(this).val()) : e) ? i = '' : 'number' == typeof i ? i += '' : Array.isArray(i) &&
      ...
      w.event,
      {
        trigger: function (t, n, i, o) {
          ...
          if (
            ...
            t.type = a > 1 ? l : d.bindType ||
            m,
            (p = (J.get(s, 'events') || {
            }) [t.type] && J.get(s, 'handle')) &&
            p.apply(s, n),
            (p = c && s[c]) &&
            p.apply &&
            Y(s) &&
    ...
    function jt(e, t, n, r) {
      var i;
      if (Array.isArray(t)) w.each(
        t,
        function (t, i) {
          n ||
          St.test(e) ? r(e, i) : jt(e + '[' + ('object' == typeof i && null != i ? t : '') + ']', i, n, r)
        }
      );
    ...
    w.fn.extend({
      ...
      serializeArray: function () {
        return this.map(
          ...
          function (e, t) {
            var n = w(this).val();
            return null == n ? null : Array.isArray(n) ? w.map(
              n,
              function (e) {
                return {
                  name: t.name,
      ...
      function a(s) {
        ...
        w.each(
          ...
          function (e, s) {
            ...
            o ||
            i[l] ? o ? !(u = l) : void 0 : (t.dataTypes.unshift(l), a(l), !1)
          }
        ),
        u
      }
      return a(t.dataTypes[0]) ||
      !i['*'] &&
      a('*')
    }
    function zt(e, t) {
    ...
    w.extend({
      ...
      ajax: function (t, n) {
        ...
        h,
        y = h.context &&
        (g.nodeType || g.jquery) ? w(g) : w.event,
        v = w.Deferred(),
        ...
        E.setRequestHeader(
          'Accept',
          h.dataTypes[0] &&
          h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ('*' !== h.dataTypes[0] ? ', ' + $t + '; q=0.01' : '') : h.accepts['*']
        );
        ...
        function k(t, n, r, s) {
          ...
          (
            ...
            l ? (
              ...
              204 === t ||
              'HEAD' === h.type ? C = 'nocontent' : 304 === t ? C = 'notmodified' : (C = b.state, p = b.data, l = !(d = b.error))
            ...
            n = function (e) {
              return function () {
                ...
                (
                  ...
                  'abort' === e ? s.abort() : 'error' === e ? 'number' != typeof s.status ? o(0, 'error') : o(s.status, s.statusText) : o(
                    Vt[s.status] ||
                    s.status,
                    s.statusText,
    ...
    w.parseHTML = function (e, t, n) {
      ...
      (
        h.createHTMLDocument ? (
          (
            i = (t = r.implementation.createHTMLDocument('')).createElement('base')
...
;
// Payment code completely disabled - not needed for crossword view
// stripe_init_timeout = null;
// stripe_init_alerted = false;
// function initStripe() removed
// Function initStripeForReal() completely disabled - not needed for crossword view
...
$(document).ready(
  function () {
    ...
    function addLegendToPage(groups) {
      for (var k in groups) {
        ...
        for (var i = 0; i < groups[k].length; i++) {
          html.push(
            '<li><strong>' + groups[k][i]['position'] + '.</strong> ' + groups[k][i]['clue'] + '</li>'
          );
        }
        $('#' + k).html(html.join('\n'));
      }
    ...
    try {
      var seed = parseInt(document.getElementById('id_seed').value, 10) ||
      0;
    } catch (e) {
    }
    seed = seed ||
    ...
    function regenerate(delay) {
      ...
      if (delay) {
        ...
        if (grid == null) {
          ...
          space.html(
            '<div class=\'message\'><div>Keep adding more words! <span id=\'why\'>Why?</span></div></div>'
          )
          space.find('#why').on(
            'click',
            function () {
              alert(
                'We couldn\'t place these words on the crossword because they don\'t have enough common letters with other words: ' + bad_words.join(', ')
              )
            }
          );
          $('#preview-header').css('visibility', 'hidden');
    ...
    if (!window.LOGGED_IN) {
      var inited = false;
      $('#id_permissions_1, #id_permissions_2').on(
        'click',
        function (e) {
          e.preventDefault();
          if (!inited) {
...
$(document).ready(
  function () {
    ...
    $('#reset-btn').on('click', function() {
      ...
      $('.cx g text.cx-a').each(function() {
        $(this).text('');
      });
      // Reset stored data if using localStorage
      if (window.CROSSWORD_ID) {
        var key = 'answers_' + window.CROSSWORD_ID;
    ...
    // Function to check if crossword is complete
    var checkCrosswordCompletion = function() {
      var allFilled = true;
      var cells = $('.cx g text.cx-a');
      
      cells.each(function() {
        var text = $(this).text().trim();
        // Only check cells that are visible (have a white background)
        var rect = $(this).parent().find('rect');
        if (rect.length > 0) {
          var fill = rect.css('fill');
          // If it's a valid cell and it's empty, mark as not filled
      ...
      if (allFilled && cells.length > 0) {
        ...
        $('#completion-message').slideDown(500);
    ...
    $('#zoom-out').on(
      ...
      clickKey(
        function (e) {
          e.preventDefault();
          zoom_level -= zoom_inc;
          zoom_level = Math.max(0.2, zoom_level);
          $('#crossword svg').css('transform', 'scale(' + zoom_level + ')');
        }
      )
    );
    ...
    $('#menu-expander').click(
      function () {
        ...
        $('#menu-expander').attr('aria-expanded', is_open ? 'true' : 'false')
        $('#mini-menu').focus();
      }
    );
    ...
    $('#cancel-show-answers').on('click', function (e) {
      $('#refund-modal').hide();
    });
    $('#show-answers-for-real').on(
      'click',
      function (e) {
        var confirmation = $('#no-refund-confirmation-text');
        if (
          confirmation.val().toLowerCase().replace(/\s+/g, '') != 'norefundforme'
        ) {
          alert('You must type \'No refund for me\' to continue');
          confirmation.select();
          confirmation.focus();
        } else {
          SHOW_ANSWER_WARNING = false;
          $('#refund-modal').hide();
          $('#refund-modal').data('ok') ()
          var req = new XMLHttpRequest();
          req.open(
            'POST',
            window.location.pathname.replace('/view/', '/answers/')
          )
          req.send();
        }
      }
    ...
    $('#show-answers-checkbox').on(
      'change',
      function (e) {
        showing_answers = this.checked;
        if (showing_answers) {
          var req = new XMLHttpRequest();
          req.open('GET', window.location.pathname.replace('/view/', '/answers/'))
          req.send();
          if (SHOW_ANSWER_WARNING) {
            this.checked = false;
            $('#refund-modal').show();
            ...
            $('#refund-modal').data(
              'ok',
              function () {
                $('#show-answers-checkbox').prop('checked', true);
                $('#show-answers-checkbox').change();
              }
            );
          } else {
    ...
    // Share link handler removed - no longer using share modal
    /*
    $('#share-link').on(
      'click',
      function (e) {
    ...
    */
    ...
    function scrollTo(to, then) {
      ...
      if (p === window) {
        ...
        var newScrollX = Math.floor(
          p.scrollLeft + (
            el.getBoundingClientRect().left - p.getBoundingClientRect().left
          )
        );
        var field_of_view_left = Math.floor(p.scrollLeft);
        var field_of_view_right = Math.floor(field_of_view_left + $(p).width());
        var field_of_view_top = Math.floor(p.scrollTop);
        var field_of_view_bottom = Math.floor(field_of_view_top + $(p).height());
      }
      field_of_view_right -= parseInt(el.getBoundingClientRect().width)
      field_of_view_bottom -= parseInt(el.getBoundingClientRect().height)
      var same = 0;
      if (
        newScrollX <= field_of_view_right &&
      ...
      if (
        newScrollY <= field_of_view_bottom &&
    ...
    function iterWordByIndex(index, f) {
      ...
      if (is_across) {
        var i = 0;
        while (c + i >= 0 && c + i < grid[r].length && grid[r][c + i] != null) {
          var id = getIdFromRowAndCol(r, c + i);
          f(r, c + i, id);
          if (grid[r][c]['across'].rtl) {
            i--;
          } else {
            i++;
          }
    ...
    function gradeAll(index_to_alert_for) {
      var all_done = true;
      ...
      for (var index in index_to_direction) {
        ...
        var is_empty = $.trim(user_string) === '' ||
        (
          !is_completely_filled_out &&
          number_of_filled_non_multi_use_cells == 0
        )
        if (is_empty) {
          all_done = false;
          clue.attr(
            'aria-description',
            number_of_cells + ' letters' + (
              $.trim(user_string) != '' ? ('. Hints ' + user_string.replace(/ /g, '_')) : ''
            )
          );
        } else if (
          user_string.toUpperCase().normalize('NFKC') == grid_string.toUpperCase().normalize('NFKC')
        ) {
          $.map(cells, function (el) {
            el.addClass('correct');
          });
          if (index_to_alert_for == index) {
          }
          ...
          clue.attr(
            'aria-description',
            'Incorrect! Current response: ' + user_string.replace(/ /g, '_')
          )
        }
        try {
      ...
      if (all_done) {
        ...
        ariaAlert('Congratulations! All done!')
    ...
    function setActiveCell(r, c, index, is_across) {
      ...
      if (index != null) {
        ...
        last_index = index;
        active_cell['rtl'] = grid[r][c][is_across ? 'across' : 'down']['rtl']
      }
      ...
      $field.attr(
        'aria-description',
        $('#clue-' + index).attr('aria-description')
      );
      $field.select()
      $field.focus();
      scrollToActiveCell();
    ...
    function onCellClick(r, c, forced_direction) {
      ...
      if (cell['across'] && cell['down'] && !forced_direction) {
        ...
        (cell['across'] != null && !forced_direction) ||
        forced_direction == 'across'
      ) {
        highlight_across = true;
        var index = grid[r][c]['across']['index'];
      } else {
    ...
    function getParent(div) {
      return $(div).closest('.valid-parent').get(0) ||
      window;
      do {
    ...
    function scrollToActiveCell() {
      ...
      scrollTo(
        ...
        function (_, _x, p) {
          ...
          $field.css({
            top: Math.floor(y + from_top),
            left: Math.floor(x + from_left),
            width: Math.floor(cell_bbox.width),
            height: Math.floor(cell_bbox.height),
          })
          $field.val('');
          $field.select()
          $field.focus();
    ...
    function highlightNextWord() {
      ...
      if (
        active_cell['is_across'] &&
        grid[r][c]['down'] &&
        grid[r][c]['down']['is_start_of_word']
      ) {
      ...
      for (; true; r = (r + 1) % grid.length, c = 0) {
        for (; c < grid[r].length; c++) {
          ...
          if (
            grid[r][c]['across'] &&
            grid[r][c]['across']['is_start_of_word']
          ) {
    ...
    // Debug shortcut: Ctrl+Shift+D to fill all cells with correct answers
    $(document).on('keydown', function(e) {
      if (e.ctrlKey && e.shiftKey && e.keyCode === 68) { // Ctrl+Shift+D
        ...
        checkCrosswordCompletion();
        console.log('Debug: All cells filled!');
      }
    });
    ...
    for (var i = 0; i < localStorage.length; i++) {
      ...
      if (key.indexOf('' + CROSSWORD_ID + '-') == 0) {
        ...
        var word = localStorage.getItem(key)
        var string = getSymbols(word);
        var rtl = is_rtl(word);
    ...
    setupDragger();
    var numbers = document.querySelectorAll('.cx-c')
    for (var i = 0; i < numbers.length; i++) {
      numbers[i].setAttribute('role', 'presentation');
    }
  }
);
function setupDragger() {
  ...
  function mouseMove(e) {
    var page_y = e.touches &&
    e.touches.length >= 1 ? e.touches[0].pageY : e.pageY
    ...
    return function (n) {
      ...
      function (t, e) {
        ...
        n.prototype = {
          ...
          off: function (t, e) {
            ...
            o = n[t],
            r = [];
            if (o && e) for (var i = 0, a = o.length; i < a; i++) o[i].fn !== e &&
            o[i].fn._ !== e &&
            r.push(o[i]);
      ...
      function (t, e, n) {
        ...
        t.exports = function (t, e, n, o, r) {
          return 'function' == typeof t.addEventListener ? i.apply(null, arguments) : 'function' == typeof n ? i.bind(null, document).apply(null, arguments) : (
            'string' == typeof t &&
